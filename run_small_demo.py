...
from utils.plot_demo_figures import plot_hetero_graph_before, plot_hetero_graph_after, plot_gantt
...
def main():
    ...
    plot_hetero_graph_before('results/hetero_graph_before.png', jobs, initial, num_m)
    plot_hetero_graph_after('results/hetero_graph_after.png', jobs, schedule_records, num_m)
